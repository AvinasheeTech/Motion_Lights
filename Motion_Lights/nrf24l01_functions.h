...
void nrf24_send_spi(uint8_t register_address, void *data, unsigned int bytes);
void nrf24_read_spi(uint8_t register_address, void *data_read, unsigned int bytes);
void nrf24_write(uint8_t register_address, uint8_t *data, unsigned int bytes);
void nrf24_read(uint8_t register_address, uint8_t *data, unsigned int bytes);
